...
class CreateWasteWaterInvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('waste_water_invoices', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('waste_water_invoices');
    }
}
